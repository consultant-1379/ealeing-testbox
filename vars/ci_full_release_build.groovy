...
def call() {
    ...
    withMaven(maven: env.MVN_HOME) {
        ...
        if (env.MVN_Release) {
              ...
              env.MAVEN_COMMAND = "-V -Dresume=false release:prepare release:perform  -DpreparationGoals=\"install -U\" -Dgoals=\"clean deploy pmd:pmd jacoco:report -U\" -DlocalCheckout=true"
        }        

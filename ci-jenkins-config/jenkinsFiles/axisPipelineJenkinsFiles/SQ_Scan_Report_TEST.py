...
def createEmail():
    ...
    <body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly;">
        ...
        <br><br><br>
            ...
            <p style="color:#ccc; margin:0; font-size:15px"> Report is generated on Friday at the end of each ENM sprint</p>
        <br>
        </div>
    ...
    with open("EmailToSend.txt", "w") as emailTxt:
        ...
        emailTxt.write("""
            ...
            <p font-size:110%;>Open newest <span style="font-weight: bold;">""")

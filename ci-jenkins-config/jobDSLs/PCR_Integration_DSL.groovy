...
*/
String projectsFile = readFileFromWorkspace('ci-jenkins-config/projects_integration')
...
def createPipelinePreCodeUnitJob(project_name) {
    ...
    */
    ...
    pipelineJob(pipeline_name) {
        ...
        description('<b>PreCodeReview with Unit and Integration test - SQ Gate not enabled.<br>')
        ...
        triggers {
            ...
            definition {
                ...
                cps {
					script(readFileFromWorkspace('ci-jenkins-config/jenkinsFiles/ciPipelineJenkinsFiles/pcr_Integration.groovy'))
                }
            }
        }
    }

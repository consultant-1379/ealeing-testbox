...
projectsFile.eachLine {
    project_details ->
        if (project_details.contains(jenkins_instance) && !project_details.contains("EXC-PCR") && project_details.contains("SILENT_MODE=false") && project_details.contains("PCR=integration")){
